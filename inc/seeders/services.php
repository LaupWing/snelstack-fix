    ...
    return [
        [
            ...
            'nl' => [
                ...
                'content' => snel_svc_blocks([
                    ...
                    'intro_b'  => 'Van leadopvolging tot facturatie. Ik bouw workflows die je bedrijfsprocessen end-to-end automatiseren met n8n en Claude.',
                    'panel_ey' => 'Hoe het werkt',
                    'panel_h'  => "Bouwen. <br>Testen. <br><span class=\"snel-muted\">Loslaten.</span>",
                    'panel_b'  => 'Ik analyseer je processen, vind de tijdvreters en bouw workflows die zichzelf runnen. Jij doet het werk dat er echt toe doet.',
                    'cards'    => [
                        ...
                        ['icon' => 'link-2',       'heading' => 'Werkt met wat je al gebruikt', 'body' => 'Van Notion tot HubSpot, van Gmail tot WhatsApp. Ik koppel de tools die jij al dagelijks gebruikt.'],
                    ],
                    'stmt_h'  => "Handmatig werk <br><span class='snel-muted'>is minder groei.</span>",
                    'stmt_p'  => 'Bedrijven die automatiseren groeien sneller en maken minder fouten. Ik bouw de workflows die dat mogelijk maken.',
                    'cont_h'  => 'Wat ik automatiseer',
                    'cont_b'  => 'Ik werk met n8n als primair automatiseringsplatform. Open-source, draait op je eigen server en geen transactiekosten. Van leadopvolging tot CRM-updates tot het automatisch genereren van rapporten.',
                    'cont_b2' => 'Elke workflow begint met een intake. Ik luister naar je processen, teken de flow uit en bouw daarna pas. Zo weet je precies wat je krijgt voordat ik begin.',
                ]),
            ],
            'en' => [
                'title'   => 'Automation',
        ...
        [
            ...
            'nl' => [
                ...
                'headline'=> "Ik kijk mee.\nJij groeit sneller.",
                'visual'  => 'ai',
                'excerpt' => 'Ik analyseer je data en processen, en bouw dan precies wat werkt.',
                'content' => snel_svc_blocks([
                    'visual'   => 'ai',
                    'badge'    => 'Data & AI',
                    'intro_h'  => "Ik kijk mee.<br><span class=\"snel-muted\">Jij groeit sneller.</span>",
                    'intro_b'  => 'Geen generiek AI-advies. Ik analyseer jouw data, jouw processen en bouw dan precies wat werkt voor jouw situatie.',
                    'panel_ey' => 'Mijn aanpak',
                    'panel_h'  => "Analyse eerst.<br><span class=\"snel-muted\">Bouwen daarna.</span>",
                    'panel_b'  => 'Voordat ik ook maar een regel code schrijf begrijp ik waar je data staat, hoe schoon die is en wat je ermee wilt bereiken.',
                    'cards'    => [
                        ['icon' => 'search',         'heading' => 'Data audit',       'body' => 'Ik analyseer waar je data staat, hoe schoon het is en wat er mist.'],
                        ['icon' => 'brain',          'heading' => 'AI strategie',     'body' => 'Concreet advies over waar AI de grootste impact maakt in jouw processen.'],
                        ['icon' => 'hammer',         'heading' => 'Implementatie',    'body' => 'Van advies naar werkende oplossing. Ik bouw het zelf.'],
                        ...
                        ['icon' => 'graduation-cap', 'heading' => 'Kennisoverdracht', 'body' => 'Jij leert hoe je het systeem beheert. Geen afhankelijkheid van mij.'],
                    ],
                    'stmt_h'  => "AI is pas nuttig<br><span class='snel-muted'>als de data klopt.</span>",
                    'stmt_p'  => 'De meeste AI-projecten mislukken niet door slechte modellen, maar door slechte data. Ik zorg dat de basis op orde is voordat ik iets bouw.',
                    ...
                    'cont_b2' => 'Ik neem je mee van nul naar een werkende AI-oplossing. Met concrete resultaten, geen vage beloftes.',
                ]),
            ],
            'en' => [
                'title'   => 'Data & AI Consultancy',
                ...
                'headline'=> "I analyse.\nYou grow faster.",
                'excerpt' => 'I analyse your data and processes, then build exactly what works.',
            ],
        ],
        [
            'menu_order' => 2,
            'nl' => [
                ...
                'content' => snel_svc_blocks([
                    ...
                    'intro_b'  => 'Generieke software dwingt je om je processen aan te passen aan het systeem. Ik bouw het systeem dat past bij jouw processen.',
                    'panel_ey' => 'Wat ik bouw',
                    ...
                    'cont_h'  => 'Mijn proces',
                    'cont_b'  => 'Ik start met een intake om te begrijpen wat je nodig hebt. Daarna bouw ik iteratief: eerst een werkend prototype, dan verfijn ik op basis van je feedback.',
                    'cont_b2' => 'Ik werk met Laravel voor complexe applicaties en WordPress voor content-gedreven platforms. Altijd met Tailwind CSS en moderne development practices.',
                ]),
            ],
            'en' => [
                'title'   => 'Custom Software',
        ...
        [
            ...
            'nl' => [
                ...
                'icon'    => '🛟',
                'tagline' => 'AI-code stuk? Ik fix het',
                'headline'=> "Vibe coding misgegaan?\nIk los het op.",
                'visual'  => 'vibe',
                'excerpt' => 'Je AI-gegenereerde code werkt niet meer. Ik duik erin en fix het snel.',
                'content' => snel_svc_blocks([
                    'visual'   => 'vibe',
                    'badge'    => 'Vibe Coding Rescue',
                    'intro_h'  => "Vibe coding misgegaan?<br><span class=\"snel-muted\">Ik los het op.</span>",
                    ...
                    'panel_ey' => 'Hoe ik te werk ga',
                    'panel_h'  => "Diagnose.<br>Fix.<br><span class=\"snel-muted\">Uitleg.</span>",
                    'panel_b'  => 'Ik duik in je code, vind de oorzaak van het probleem en fix het zonder andere dingen stuk te maken. Je krijgt ook uitleg zodat je het de volgende keer zelf herkent.',
                    'cards'    => [
                        ['icon' => 'search',          'heading' => 'Snelle diagnose', 'body' => 'Ik analyseer de foutmelding en vind de oorzaak, ook als de AI dat niet kon.'],
                        ...
                        ['icon' => 'test-tube',       'heading' => 'Getest',          'body' => 'Na de fix test ik grondig of alles werkt zoals verwacht.'],
                    ...
                    'cont_h'  => 'Wat kan ik fixen?',
                    'cont_b'  => 'TypeErrors, API-fouten, build problemen, performance issues, authenticatie bugs, database queries die verkeerd lopen. Als het code is, kan ik het fixen.',
                    'cont_b2' => 'Ik werk met React, Next.js, Laravel, WordPress, Node.js en meer. Stuur me je foutmelding en ik vertel je binnen een uur of ik je kan helpen.',
                ]),
            ],
            'en' => [
                'title'   => 'Vibe Coding Rescue',
                'slug'    => 'vibe-coding-rescue',
                'tagline' => 'AI code broken? I fix it',
                'headline'=> "Vibe coding gone wrong?\nI fix it.",
                'excerpt' => 'Your AI-generated code stopped working. I dive in and fix it fast.',
            ],
        ],
        [
            'menu_order' => 4,
            'nl' => [
                ...
                'slug'    => 'websites',
                'icon'    => '🌐',
                'tagline' => 'Snel live, snel gevonden',
                'headline'=> "Razendsnel live.\nKlaar om te groeien.",
                'visual'  => 'speed',
                'excerpt' => 'Snelle, strakke websites. Vaak het startpunt voor de automatisering erachter.',
                'content' => snel_svc_blocks([
                    'visual'   => 'speed',
                    'badge'    => 'Websites',
                    'intro_h'  => "Razendsnel live.<br><span class=\"snel-muted\">Klaar om te groeien.</span>",
                    'intro_b'  => 'Geen trage templates. Ik ontwerp en bouw je website zelf: snel, strak en gebouwd om gevonden te worden.',
                    'panel_ey' => 'Waarom bij mij',
                    'panel_h'  => "Design en code.<br><span class=\"snel-muted\">Door één persoon.</span>",
                    'panel_b'  => 'Geen overdracht tussen designer en developer. Ik doe beide, dus je site is sneller af en klopt tot in de details.',
                    'cards'    => [
                        ['icon' => 'zap',         'heading' => 'Razendsnel',        'body' => 'Geoptimaliseerd voor snelheid. Bezoekers wachten niet, en Google beloont het.'],
                        ['icon' => 'cursor',      'heading' => 'Eigen design',      'body' => 'Geen template dat iedereen al heeft. Ontworpen voor jouw merk en jouw klanten.'],
                        ['icon' => 'search',      'heading' => 'SEO vanaf dag een', 'body' => 'Techniek en structuur staan goed, zodat je gevonden wordt op wat jij verkoopt.'],
                        ['icon' => 'globe',       'heading' => 'Meertalig',         'body' => 'Nederlands en Engels vanaf de start, zonder dure vertaalplugins.'],
                        ['icon' => 'hammer',      'heading' => 'Zelf te beheren',   'body' => 'Teksten en afbeeldingen pas je gewoon zelf aan in WordPress.'],
                        ['icon' => 'trending-up', 'heading' => 'Klaar voor meer',   'body' => 'Vaak het startpunt: eerst de site, daarna de automatisering erachter.'],
                    ],
                    'stmt_h'  => "Je website is<br><span class='snel-muted'>je eerste indruk.</span>",
                    'stmt_p'  => 'Binnen een paar seconden beslist een bezoeker of hij blijft. Een snelle, strakke site verdient zichzelf terug.',
                    'cont_h'  => 'Hoe ik websites bouw',
                    'cont_b'  => 'Ik bouw met WordPress en een eigen theme: geen page builders, geen ballast. Daardoor is de site snel, veilig en makkelijk te beheren.',
                    'cont_b2' => 'Een website is bij mij vaak het startpunt. Daarna koppel ik er automatisering achter: leadopvolging, formulieren die je CRM vullen, rapportages die zichzelf maken.',
                ]),
            ],
            'en' => [
                'title'   => 'Websites',
                'slug'    => 'websites',
                'tagline' => 'Fast to launch, easy to find',
                'headline'=> "Lightning fast.\nReady to grow.",
                'excerpt' => 'Fast, clean websites. Often the starting point for the automation behind it.',
            ],
        ],
    ];
}
